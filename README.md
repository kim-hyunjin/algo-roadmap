...
- 각 유형의 적용 조건, 그대로 쓰면 안 되는 경우, 평균·최악·분할상환 복잡도 조건을 구분합니다.
- 이전·다음 버튼으로 알고리즘 상태 변화를 시각적으로 따라갈 수 있습니다.
- Python, JavaScript, C++ 풀이 템플릿을 제공합니다.
...
제품 범위와 콘텐츠 원칙은 [`PLAN.md`](PLAN.md), 2026-08-04 전수 검토와 수정 근거는
[`CONTENT_REVIEW.md`](CONTENT_REVIEW.md)를 참고하세요.
